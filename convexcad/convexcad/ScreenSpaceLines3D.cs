...
{
    /// <summary>
    ///     SafeScreenSpaceLines3D are a 3D line primitive whose thickness
    ...
    /// </summary>
    public class SafeScreenSpaceLines3D : ModelVisual3D, IDisposable
    {
        public SafeScreenSpaceLines3D()
        {
        ...
        {
            ((SafeScreenSpaceLines3D)sender).SetColor((Color) args.NewValue);
        }
        ...
        public void AddLine(Point3D linea, Point3D lineb)
        {
            Points.Add(linea);
            Points.Add(lineb);
        }

        public void AddCross(Point3D centre, double sz)
        {
            sz *= 0.5;
            AddLine(centre - new Vector3D(sz, 0, 0), centre + new Vector3D(sz, 0, 0));
            AddLine(centre - new Vector3D(0, sz, 0), centre + new Vector3D(0, sz, 0));
            AddLine(centre - new Vector3D(0, 0, sz), centre + new Vector3D(0, 0, sz));
        }
        ...
        {
            ((SafeScreenSpaceLines3D)sender).GeometryDirty();
        }
